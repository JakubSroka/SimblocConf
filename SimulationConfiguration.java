...
public class SimulationConfiguration {
   ...
   */
  //TODO revert
  public static final int NUM_OF_NODES = 111;//600;//800;//6000;
   ...
   */
  //TODO
  public static final int AVERAGE_COINS = 6000;
  /**
   * The constant STDEV_OF_COINS.
   */
  //TODO
  public static final int STDEV_OF_COINS = 2500;

  /**
   * The reward a PoS minter gets for staking.
   */
  public static final double STAKING_REWARD = 0.10;
   ...
   */
  public static final long BLOCK_SIZE = 8000;//6110;//8000;//535000;//0.5MB
}
